...
void CWhisper::AppendChat(int iType, const char * c_szChat)
{
    ...
    CGraphicText* pkDefaultFont = (iType == CPythonChat::WHISPER_TYPE_GM) ? static_cast<CGraphicText*>(DefaultFont_GetResource()) : static_cast<CGraphicText*>(DefaultFont_GetResource());
#else
